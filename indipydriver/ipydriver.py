...
class IPyDriver(collections.UserDict):
    ...
    """A subclass of this should be created with methods written
       ...
       coros are optional positional arguments, being co-routines that
       you may have created to operate your instruments, the co-routines set
       here will all be awaited when the driver is run.
    ...
    def __init__(self, devices, *coros, **driverdata):
        ...
        # _coros is a set of co_routines to be started
        self._coros = coros
        # self._tasks holds tasks to be generated by self.asyncrun()
        self._tasks = []
